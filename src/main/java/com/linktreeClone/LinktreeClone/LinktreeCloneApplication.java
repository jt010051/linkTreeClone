...
import com.linktreeClone.LinktreeClone.service.LinkTreeImpl;
...
//		}
	...
	@Bean
	CommandLineRunner run(LinkTreeImpl linkserve) {	 //delete later
		return args -> {
...
//links.add(instagram);
//links.add(linkedin);
linkserve.create(youtube);
linkserve.create(facebook);
linkserve.create(twitter);
linkserve.create(instagram);
linkserve.create(linkedin); //temporary
//
